...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////
////// This script is a very basic camera movement used to demonstrate how the Aircraft Instruments works
...
namespace MGAssets
{
    public class AircraftDemo : MonoBehaviour
    {
        public static AircraftDemo current;

        public bool isActive = true, cursorStartLocked = false, allowMouse = true, turbulence = true;
        ...
        void FixedUpdate() //Update()
        {
            ...
            if (Input.GetKey(KeyCode.T)) { transform.localRotation = Quaternion.identity; transform.localPosition = new Vector3( 0, 98, 0); }
            if (Input.GetKey(KeyCode.Space)) transform.localEulerAngles = new Vector3(0, transform.localEulerAngles.y, 0);
            //
            ...
            if (allowMouse && Cursor.lockState == CursorLockMode.Locked)
            {
                transform.Rotate(
